...
import GoTotopButton from '@/app/components/go-to-top-button'
      ...
      <section className={s.projects}>
        <div className="container">
          ...
          <Project
            ...
            image={{
              src: "/images/10-segundos-score-system.png",
